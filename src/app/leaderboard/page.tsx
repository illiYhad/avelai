...
export default function LeaderboardPage() {
    ...
    return (
        <main className="min-h-screen bg-[#030308] text-white p-4 md:p-8 font-mono relative overflow-hidden">
            ...
            {/* Leaderboard Table */}
            <div className="max-w-6xl mx-auto border border-cyan-500/20 bg-black/60 backdrop-blur-md rounded-sm p-1 shadow-[0_0_30px_rgba(6,182,212,0.05)]">
                                        ...
                                        >
                                            ...
                                            <td className="py-4 px-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <span className="text-sm font-bold tracking-wide text-gray-200 group-hover:text-cyan-400 transition-colors duration-150">
