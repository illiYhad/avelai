...
export const ITEM_ID_TO_NAME: Record<number, string> = {
    ...
    30: 'gem', 31: 'cloak', 32: 'talisman_of_evasion', 34: 'magic_stick', 36: 'magic_wand',
    38: 'clarity', 39: 'flask', 40: 'dust', 41: 'bottle', 42: 'ward_observer',
    ...
    67: 'oblivion_staff', 69: 'pers', 71: 'poor_mans_shield', 73: 'bracer', 75: 'wraith_band',
    77: 'null_talisman', 79: 'mekansm', 81: 'vladmir', 86: 'buckler', 88: 'ring_of_basilius',
    90: 'pipe', 92: 'urn_of_shadows', 94: 'headdress', 96: 'sheepstick', 98: 'orchid',
    100: 'cyclone', 102: 'force_staff', 104: 'dagon', 106: 'necronomicon', 108: 'ultimate_scepter',
    110: 'refresher', 112: 'assault', 114: 'heart', 116: 'black_king_bar', 117: 'aegis',
    119: 'shivas_guard', 121: 'bloodstone', 123: 'sphere', 125: 'vanguard', 127: 'blade_mail',
    129: 'soul_booster', 131: 'hood_of_defiance', 133: 'rapier', 135: 'monkey_king_bar',
    137: 'radiance', 139: 'butterfly', 141: 'greater_crit', 143: 'basher', 145: 'bfury',
    147: 'manta', 149: 'lesser_crit', 151: 'armlet', 152: 'invis_sword', 154: 'sange_and_yasha',
    ...
    176: 'ethereal_blade', 178: 'soul_ring', 180: 'arcane_boots', 181: 'orb_of_venom',
    182: 'stout_shield', 185: 'ancient_janggo', 187: 'medallion_of_courage', 188: 'smoke_of_deceit',
    190: 'veil_of_discord', 206: 'rod_of_atos', 208: 'abyssal_blade', 210: 'heavens_halberd',
    212: 'ring_of_aquila', 214: 'tranquil_boots', 215: 'shadow_amulet', 216: 'glimmer_cape',
    218: 'solar_crest', 220: 'travel_boots_2', 226: 'lotus_orb', 229: 'solar_crest',
    231: 'guardian_greaves', 232: 'octarine_core', 235: 'octarine_core', 236: 'dragon_lance',
    247: 'moon_shard', 249: 'silver_edge', 250: 'bloodthorn', 252: 'echo_sabre',
    254: 'glimmer_cape', 259: 'aeon_disk', 261: 'kaya', 263: 'refresher_shard',
    265: 'hurricane_pike', 267: 'spirit_vessel', 271: 'holy_locket', 273: 'kaya_and_sange',
    277: 'yasha_and_kaya', 279: 'ring_of_tarrasque', 609: 'aghanims_shard'
};
...
export const getHeroImageUrl = (heroName?: string, heroId?: number): string => {
    ...
    if (heroId && HERO_ID_TO_NAME[heroId]) {
        name = HERO_ID_TO_NAME[heroId];
    } else if (heroName && isNaN(Number(heroName))) {
        name = heroName.replace('npc_dota_hero_', '').toLowerCase().replace(/[^a-z0-9_]/g, '');
    }
...
export const getItemImageUrl = (itemId?: number | string): string => {
    ...
    if (typeof itemId === 'number' || !isNaN(Number(itemId))) {
        name = ITEM_ID_TO_NAME[Number(itemId)] || '';
    } else if (typeof itemId === 'string') {
        name = itemId.replace('item_', '');
    }
